...
import { getconductortrips,getdrivertrips } from '../redux/actions/admin';
import FormLoading from './FormLoading';
import { useSelector,useDispatch } from 'react-redux'
function DriversPage({data:conductorsInfo}) {
    ...
    const trips=useSelector((state)=>state.getDriverTrips);
    let {loading,error,data}=trips;
  
    console.log(trips);
    useEffect(() => {
      dispatch(getdrivertrips(signature))
  
  
      }, [getdrivertrips,dispatch])
